...
/***/ (function(module, exports) {
	...
	var UnionType = exports.UnionType = function (_Type) {
	    ...
	    function UnionType(introspectionType) {
	        ...
	        var _this2 = _possibleConstructorReturn(this, (UnionType.__proto__ || Object.getPrototypeOf(UnionType)).call(this, introspectionType));
	
	        _this2.possibleTypes = introspectionType.possibleTypes.map(function (r) {
	...
	var ObjectType = exports.ObjectType = function (_Type2) {
	    _inherits(ObjectType, _Type2);
	    ...
	    function ObjectType(introspectionType) {
	        ...
	        var _this3 = _possibleConstructorReturn(this, (ObjectType.__proto__ || Object.getPrototypeOf(ObjectType)).call(this, introspectionType));
	
	        _this3.fields = introspectionType.fields.map(function (f) {
	            return new Field(f);
	        });
	
	        if (introspectionType.interfaces) {
	            _this3.interfaces = introspectionType.interfaces.map(function (r) {
	                return TypeRef.fromIntrospectionRef(r);
	            });
	        } else {
	            _this3.interfaces = [];
